    ...
    template:  `
        <span [ngClass]="{'ui-calendar':true,'ui-calendar-w-btn':showIcon}" [ngStyle]="style" [class]="styleClass">
            <div class="input-group">
              <input type="text" *ngIf="!inline" (focus)="onInputFocus($event)" (keydown)="onInputKeydown($event)" (click)="closeOverlay=false" (blur)="onInputBlur($event)"
              ...
              <!--<span class="input-group-btn" *ngIf="showIcon">-->
                <!--<button class="btn btn-default" type="button" (click)="onButtonClick($event)"-->
            ...
            <div class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" [ngClass]="{'ui-datepicker-inline':inline,'ui-shadow':!inline,'ui-state-disabled':disabled}" 
                ...
                <div class="ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all" *ngIf="!timeOnly">
                    ...
                    <div class="ui-datepicker-title">
                        <span class="ui-datepicker-year" *ngIf="!yearNavigator">{{currentYear}}年</span>
...
export class Calendar implements AfterViewInit,OnInit,OnDestroy,ControlValueAccessor {
    ...
    @Input() placeholder: string = '格式：1990-01-01';
    ...
    ngAfterViewInit() {
        ...
        if(!this.inline) {
            this.inputfield = this.domHandler.findSingle(this.el.nativeElement, 'input');//this.el.nativeElement.children[0].children[0];
        }
