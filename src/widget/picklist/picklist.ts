        ...
        <div [class]="styleClass" [ngStyle]="style" [ngClass]="{'ui-picklist ui-widget ui-helper-clearfix': true,'ui-picklist-responsive': responsive}">
            <div class="ui-picklist-source-controls ui-picklist-buttons" *ngIf="showSourceControls">
                <div class="ui-picklist-buttons-cell">
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveUp(sourcelist,source)"><i class="fa fa-angle-up"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveTop(sourcelist,source)"><i class="fa fa-angle-double-up"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveDown(sourcelist,source)"><i class="fa fa-angle-down"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveBottom(sourcelist,source)"><i class="fa fa-angle-double-down"></i></button>
                </div>
            </div>
            ...
            <div class="ui-picklist-buttons">
                <div class="ui-picklist-buttons-cell">
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveRight(targetlist)"><i class="fa fa-angle-right"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveAllRight()"><i class="fa fa-angle-double-right"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveLeft(sourcelist)"><i class="fa fa-angle-left"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveAllLeft()"><i class="fa fa-angle-double-left"></i></button>
                </div>
            </div>
            ...
            <div class="ui-picklist-target-controls ui-picklist-buttons" *ngIf="showTargetControls">
                <div class="ui-picklist-buttons-cell">
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveUp(targetlist,target)"><i class="fa fa-angle-up"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveTop(targetlist,target)"><i class="fa fa-angle-double-up"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveDown(targetlist,target)"><i class="fa fa-angle-down"></i></button>
                    <button type="button" class="btn btn-default btn-circle-micro" (click)="moveBottom(targetlist,target)"><i class="fa fa-angle-double-down"></i></button>
                </div>
            </div>
        </div>
    `,
