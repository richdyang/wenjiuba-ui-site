...
<table class="table">
    <caption class="text-center">
        ...
        <span class="pull-right">
            <button uiSref="shop.records.record.items.new" class="btn btn-default btn-circle-micro" tooltip="添加" placement="bottom"><i class="wj-icon wj-add"></i></button>
            <button uiSref="shop.records.record.edit" [uiParams]="{recordId: record.id}" class="btn btn-default btn-circle-micro" tooltip="修改" placement="bottom">
...
<div class="panel panel-default" *ngFor="let recordItem of record.items">
    <div class="panel-heading">
        ...
        <button uiSref="shop.records.record.items.item.edit" [uiParams]="{recordItemId: recordItem.id}" class="btn btn-default btn-circle-micro pull-right" tooltip="修改" placement="bottom">
            <i class="wj-icon wj-edit"></i>
        </button>
    </div>
