...
@Component({
    ...
    <table class="table table-striped table-hover">
        <caption class="text-right">
            <button uiSref="shop.records.new" class="btn btn-primary btn-circle-micro"><i class="wj-icon wj-add"></i></button>
        </caption>
        <thead>
        <tr>
            <th>客户</th>
        ...
        <tr *ngFor="let record of records">
            ...
            <td class="text-right">
                <button uiSref="shop.records.record" [uiParams]="{recordId: record.id}" class="btn btn-default btn-circle-micro" title="修改">
