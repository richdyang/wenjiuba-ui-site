  ...
  <div class="page-header">
    ...
    <table class="table table-striped table-hover">
      <caption class="text-right">
        <button uiSref="shop.employees.new" class="btn btn-primary btn-circle-micro" tooltip="添加" placement="bottom"><i class="wj-icon wj-add"></i></button>
      </caption>
      <thead>
        <tr>
          <th>姓名</th>
      ...
      <tbody>
        <tr *ngFor="let employee of employees">
          ...
          <td class="text-right">
            <button uiSref="shop.employees.employee.edit" [uiParams]="{employeeId: employee.id}" class="btn btn-default btn-circle-micro" tooltip="修改" placement="bottom">
